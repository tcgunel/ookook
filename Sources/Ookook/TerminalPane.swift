...
// The agent marks (ClaudeMark, OpenCodeMark) live in SpinnerMark.swift: their
// animation is cycled by Core Animation rather than by a SwiftUI timer, which
// keeps a sidebar full of working agents off the main thread.
